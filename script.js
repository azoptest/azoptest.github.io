...
function getWebGlExtensions() {
    ...
    console.time("webglblock1")
    const gl = getWebGLContext()
    if (!gl) {
        return -1
    }
    console.timeEnd("webglblock1")
    console.time("webglblock2")
    const extensions = gl.getSupportedExtensions()
    const contextAttributes = gl.getContextAttributes()
    const unsupportedExtensions = []
    console.timeEnd("webglblock2")
    // Features
    const attributes = []
    const parameters = []
    ...
    console.timeEnd("webglblock3")
    // Extension parameters
    if (extensions) {
        console.time("webglblock4")
        ...
        console.timeEnd("webglblock4")
    }

    console.time("webglblock5")
    // Shader precision
    ...
    console.timeEnd("webglblock5")
    // Postprocess
    console.time("webglblock6")
    extensionParameters.sort()
    parameters.sort()
    console.timeEnd("webglblock6")
    result = {
